...
void ScoutSkidSteer::TwistCmdCallback(
  ...
  motor_cmd[0].data = right_side_velocity *k; // 여기 추가한 곳임
  motor_cmd[1].data = -left_side_velocity *k; // 여기 추가한 곳임
  motor_cmd[2].data = -left_side_velocity *k; // 여기 추가한 곳임
  motor_cmd[3].data = right_side_velocity *k; // 여기 추가한 곳임
